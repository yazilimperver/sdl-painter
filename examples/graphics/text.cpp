...
static void DrawLabelBox(sdl_painter::Painter& p, const sdl_painter::Rect& box,
...
int main() {
  ...
  SDL_Window* window =
      SDL_CreateWindow("SDLPainter — text: Metin Çizimi (Phase 4)", 900, 650,
...

  {
    ...
    spdlog::info("MeasureText: \"SDLPainter text demo\" -> {}x{} piksel", mw,
                 mh);
    ...
    while (running) {
      ...
      DrawLabelBox(painter, {kStartX, kBoxY, kBoxW, kBoxH}, "Sol hizalı metin",
      ...
      DrawLabelBox(painter, {kStartX + kBoxW + kGap, kBoxY, kBoxW, kBoxH},
                   "Orta hizalı Türkçe metin", sdl_painter::Alignment::kCenter,
      ...
      DrawLabelBox(painter,
                   ...
                   "Sag hizalı metin (öçşığü)", sdl_painter::Alignment::kRight,
      ...
      painter.SetPen(
          sdl_painter::Pen(sdl_painter::Color{220, 220, 220, 255}, 0.0f));
      ...
      const char* color_texts[] = {
          "Kırmızı metin", "Yeşil metin", "Mavi metin",
          "Sari metin",    "Mor metin",
      };
      for (int32_t i = 0; i < 5; ++i) {
        painter.SetPen(sdl_painter::Pen(colors[i], 0.0f));
        painter.DrawText(20.0f + static_cast<float>(i) * 170.0f, col_y,
                         color_texts[i]);
      }
      ...
      painter.SetFont(font_lg);
      painter.SetPen(
          sdl_painter::Pen(sdl_painter::Color{255, 255, 255, 255}, 0.0f));
      ...
      painter.SetFont(font_md);
      painter.SetPen(
          sdl_painter::Pen(sdl_painter::Color{255, 160, 60, 255}, 0.0f));
      ...
      painter.SetFont(font_sm);
      painter.SetPen(
          sdl_painter::Pen(sdl_painter::Color{120, 120, 120, 255}, 0.0f));
      painter.SetOpacity(1.0f);
