...
int main() {
  ...
  SDL_Window* window = SDL_CreateWindow(
      "SDLPainter — Phase 2: Transform Stack & Clip",
      900, 700,
...

  {
    ...
    while (running) {
      ...
      painter.SetBrush(sdl_painter::Brush(sdl_painter::Color{80, 140, 220, 220}));
      painter.FillRect(0.0f, 0.0f, 100.0f, 60.0f);
      painter.Translate(30.0f, 25.0f);
      painter.SetBrush(sdl_painter::Brush(sdl_painter::Color{220, 100, 80, 200}));
      painter.FillRect(0.0f, 0.0f, 100.0f, 60.0f);
      painter.Translate(30.0f, 25.0f);
      painter.SetBrush(sdl_painter::Brush(sdl_painter::Color{80, 200, 130, 200}));
      painter.FillRect(0.0f, 0.0f, 100.0f, 60.0f);
      painter.Restore();
      ...
      painter.SetBrush(sdl_painter::Brush(sdl_painter::Color{255, 200, 50, 220}));
      painter.SetPen(sdl_painter::Pen(sdl_painter::Color{255, 240, 180, 255}, 2.0f));
      ...
      // ----------------------------------------------------------------
      {
        ...
        painter.SetBrush(sdl_painter::Brush(sdl_painter::Color{150, 80, 220, 220}));
        painter.FillCircle(0.0f, 0.0f, 50.0f);
        painter.SetPen(sdl_painter::Pen(sdl_painter::Color{200, 150, 255, 255}, 2.0f));
      ...
      painter.Save();
        ...
        painter.SetBrush(sdl_painter::Brush(sdl_painter::Color{60, 180, 200, 200}));
        painter.FillRect(-50.0f, -50.0f, 100.0f, 100.0f);

        painter.Save();
          painter.Rotate(angle * 1.5f);
          painter.Scale(0.5f, 0.5f);
          painter.SetBrush(sdl_painter::Brush(sdl_painter::Color{255, 120, 60, 220}));
          painter.FillRect(-50.0f, -50.0f, 100.0f, 100.0f);

          painter.Save();
            painter.Rotate(-angle * 2.0f);
            painter.Scale(0.5f, 0.5f);
            painter.SetBrush(sdl_painter::Brush(sdl_painter::Color{50, 220, 120, 220}));
            painter.FillRect(-50.0f, -50.0f, 100.0f, 100.0f);
          painter.Restore();
        painter.Restore();
      painter.Restore();
      ...
      painter.SetPen(sdl_painter::Pen(sdl_painter::Color{200, 200, 200, 180}, 1.5f));
      ...
      painter.SetBrush(sdl_painter::Brush(sdl_painter::Color{80, 160, 255, 180}));
      ...
      painter.Rotate(angle);
      painter.SetBrush(sdl_painter::Brush(sdl_painter::Color{255, 180, 60, 200}));
      ...
      painter.SetBrush(sdl_painter::Brush(sdl_painter::Color{200, 50, 100, 200}));
      painter.SetPen(sdl_painter::Pen(sdl_painter::Color{255, 100, 150, 255}, 2.0f));
      ...
      // ----------------------------------------------------------------
      {
        ...
        painter.Scale(sx, sy);
        painter.SetBrush(sdl_painter::Brush(sdl_painter::Color{100, 220, 180, 200}));
        painter.SetPen(sdl_painter::Pen(sdl_painter::Color{180, 255, 230, 255}, 1.5f));
